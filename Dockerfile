...
RUN   chmod +x build-install.sh ./alfresco-community-installer-201707-linux-x64.bin /install.sh /passencode.py /modifinitpass.sh /tunesolr.sh /tunerepo.sh /waitready.sh /entry.sh /tuneglobal.sh /apply_amps_unatended.sh
